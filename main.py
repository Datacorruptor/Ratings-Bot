...
async def on_ready():
    try:
        ...
        logger.log_error("========== ON READY EXCEPTION ==========")
        logger.log_error(ex)
...
async def on_command_error(ctx, error):
    try:
        ...
        logger.log_error("========== ON COMMAND ERROR EXCEPTION ==========")
        logger.log_error(ex)
...
async def secondyCheck():
    try:
        ...
        logger.log_error("========== ON TIMER_SECONDS EXCEPTION ==========")
        logger.log_error(ex)
    pass
...
async def activityCheck():
    try:
        ...
        logger.log_error("========== ON TIMER_ACTIVITY EXCEPTION ==========")
        logger.log_error(ex)
    pass
...
async def monthlyCheck():
    try:
        ...
        logger.log_error("========== ON TIMER_MONTH EXCEPTION ==========")
        logger.log_error(ex)
    pass
...
async def hourlyCheck():
    try:
        ...
        logger.log_error("========== ON TIMER_HOURS EXCEPTION ==========")
        logger.log_error(ex)
    pass
...
async def on_member_join(member):
    try:
        ...
        logger.log_error("========== ON MEMBER JOIN EXCEPTION ==========")
        logger.log_error(ex)
...
async def on_message(message):
    try:
        ...
        logger.log_error("========== ON MESSAGE EXCEPTION ==========")
        logger.log_error(ex)
    pass
...
async def addPointsChannelCommand(ctx, id: int, amount: int, reason):
    try:
        ...
        logger.log_error("========== ON addpoints channel command EXCEPTION ==========")
        logger.log_error(ex)
...
async def addPointsCommand(ctx, id: int, amount: int, reason):
    try:
        ...
        logger.log_error("========== ON addpoints command EXCEPTION ==========")
        logger.log_error(ex)
...
async def addTicketsCommand(ctx, id: int, amount: float, reason):
    try:
        ...
        logger.log_error("========== ON addTickets EXCEPTION ==========")
        logger.log_error(ex)
...
async def getPointsCommand(ctx):
    try:
        ...
        logger.log_error("========== ON getPoints EXCEPTION ==========")
        logger.log_error(ex)
...
async def getRatingCommand(ctx):
    try:
        ...
        logger.log_error("========== ON getRating EXCEPTION ==========")
        logger.log_error(ex)
...
async def getMonthlyRatingCommand(ctx):
    try:
        ...
        logger.log_error("========== ON getMonthlyRating EXCEPTION ==========")
        logger.log_error(ex)

@client.command(name='image', help='generate image')
async def genImage(ctx, promt):
    try:
        print(promt)
        await command_genImage(ctx,client,promt)
    except Exception as ex:
        logger.log_error("========== ON genImage EXCEPTION ==========")
        logger.log_error(ex)
...
async def transfer(ctx, id: int, amount: float):
    try:
        ...
        logger.log_error("========== ON transfer EXCEPTION ==========")
        logger.log_error(ex)
